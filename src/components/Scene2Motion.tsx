...
const LINES: Line[] = [
  { from: 6,  to: 12, who: "ant", text: "영차 영차 열심히 일하자! 이제 곧 겨울이 올거야 더 추워지기 전에 열심히 일하자" },
  { from: 12, to: 18, who: "ant", text: "자 이것도 가져가도, 요것도 챙겨가자, 어이 친구 거기 있는 재료 좀 챙겨줘" },
  ...
  { from: 58, to: 64, who: "ant", text: "미안해 하지만 아직 해야 할 게 많아서 우린 계속 일할께" },
  { from: 64, to: 70, who: "gh",  text: "아이고 딱해라 열심히 일만 하느라 놀지를 못하네 내가 너희들을 위해 즐거운 노래를 불러줄께" },
